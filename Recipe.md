...
1. create new repository in github (name it something relevant to the project)
...
6. create a requirements.txt file and add the correct libraries and versions for the project. Then, install the requirements.txt file and any other packages you need via the terminal.
7. create any files (such as .py or .ipynb) or code/folders that your project needs.
